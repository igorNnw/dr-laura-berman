        ...
        youtubeVideoGallery:function(options) {
            ...
            function load($this, options) {
                var videos = ( options.videos.length ) ? options.videos : getVideoLinks($this),
                    ...
                    playButtonSrc = options.playButton ,
                ...
                for (var i = 0, l = videos.length; i < l; i++){
                    ...
                    html+= '<li class="youtube-videogallery-item" data-topic="'+video.topic+'"><a title="'+video.title+'" data-youtube-id="'+ video.id +'" href="'+ href +'" class="youtube-videogallery-link" style="width:'+options.thumbWidth+'px"><img class="youtube-videogallery-play" src="'+ playButtonSrc +'" title="play" /><img class="youtube-videogallery-img" src="'+ src +'" style="width:'+options.thumbWidth+'px" />'+ titleSpan +'</a></li>';
                }
                $this.empty()
                    .append(html)
